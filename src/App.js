...
import FirstYearNotes from './Components/FirstYearNotes';
import SeniorYearNotes from './Components/SeniorYearNotes';
...
import FirstYearPYQ from './Components/FirstYearPYQ';
import SeniorYearPYQ from './Components/SeniorYearPYQ';
...
{/* <Route path="/second-year/:branch" element={<SecondYearCluster />} /> */}
    ...
    <Router>
      <div className='App'>
        ...
        <Routes>
          ...
          <Route path="/Senioryearnotes" element={<SeniorYearNotes />} />
          ...
          <Route path="/firstyearpyq" element={<FirstYearPYQ />} />
          <Route path="/senioryearpyq" element={<SeniorYearPYQ />} />
