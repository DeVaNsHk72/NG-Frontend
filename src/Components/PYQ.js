...
// ────────────────────────────────────────────────
// MAIN COMPONENT – permanently dark
// ────────────────────────────────────────────────
export default function PYQSelector() {
  return (
    <div className="flex flex-col text-slate-200  ">
      ...
      {/* Content */}
      <main className="flex-1 flex flex-col min-h-screen items-center justify-center p-4 pt-24 md:p-8">
        <div className="text-center mb-12 animate-fade-in">
          <h1 className="text-4xl md:text-5xl font-extrabold text-white">Previous Year Questions</h1>
          <p className="mt-4 text-lg text-slate-400">Find question papers for CIE and SEE assessments.</p>
        </div>
