    ...
    const ShowSelectedCycleRelatedPdf = ()=>{
      ...
      if(Sem3){
        ...
        setShowSubjectsClicked(true)
          ...
          axios.post("hhttps://ng-backend-1-f4r9.onrender.com/api/SecondYear/SelectedBranchPdf",myData)
          .then(response=>{
        ...
        if (input.length) {
          ...
          else
          {
            ...
            searchTerm = { SubjectName:input,Branch:"CSE" };
              ...
              setTimeout(() => {
                axios.post("hhttps://ng-backend-1-f4r9.onrender.com/api/GetSearchedBranchRelatedSubjects", searchTerm)
                  .then(response2 => {
...
<div   className="flex cursor-pointer  flex-col gap-2  border-custom-dark border-2  bg-custom-dark rounded-lg shadow-lg p-4 mx-auto w-full max-w-3xl">
