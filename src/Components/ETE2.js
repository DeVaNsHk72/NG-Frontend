...
<div   className="flex cursor-pointer bg-custom-dark flex-col gap-2 bg-black border-2 border-custom-dark rounded-lg shadow-lg p-4 mx-auto w-full max-w-3xl">
